...
class AppRoutes {
  ...
  static final menuOptions = <MenuOption>[
    ...
    //     icon: Icons.home),
    MenuOption(route: 'listView', name: 'ListView Screen', screen: const ListViewScreen(), icon: Icons.list),
    MenuOption(route: 'listViewFinished', name: 'ListView Finished Screen', screen: const ListViewFinishedScreen(), icon: Icons.list_alt),
