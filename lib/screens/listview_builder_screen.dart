    ...
    return Scaffold(
      ...
      child: Stack(
        children: [
          ...
          if (isLoading)
            Positioned(bottom: 40, left: (size.width * 0.5) - 30, child: const _LoadingIcon()),
        ],
      ),
    ));
  }
...
class _LoadingIcon extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      height: 60,
      width: 60,
      decoration: BoxDecoration(color: AppTheme.white.withOpacity(0.8), shape: BoxShape.circle),
